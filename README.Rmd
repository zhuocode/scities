...
knitr::include_graphics("cran_packages.png")
```
...
knitr::include_graphics("r_example.png")
```
...
```{r echo = F}
setwd("/Users/geoaco/Desktop/my_docs_mac/leeds_work/teaching_18/data_sci/")
```
...
```{r}
# load Spatial data  
setwd("/Users/geoaco/Desktop/my_docs_mac/leeds_work/teaching_18/data_sci/MSOA_BoundaryData")
msoa <- st_read("england_msoa_ru_classn_2011.shp")  
```
